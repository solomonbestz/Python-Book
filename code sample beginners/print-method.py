...
"""
#input() #This input method allows us write in data to our program


"""
Whaterver the user writes as his or her name, the data would be stored in name 
variable
we could print out the users data using our print method, remember the print method
converts all data to strins
